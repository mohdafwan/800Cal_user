    ...
    return WillPopScope(
      ...
      child: SafeArea(
        ...
        appBar: AppBar(
          ...
          backgroundColor: AppColor.pimaryColor,
          title: Text(
            c.lang == 'en' ? AppText.profileEn : AppText.addAmountAr,
            style: TextStyle(
              fontSize: 30,
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  // CustomAppBar(
                  //   text:
                  //       c.lang == 'en' ? AppText.profileEn : AppText.profileAr,
                  //   showProfile: false,
                  // ),
                  heightBox(10),
        ...
        itemBuilder: (BuildContext context, int index) {
          return FittedBox(
            ...
            child: index == 1
                ...
                : index == 0 && model.subusers.length == 1
                    ? InkWell(
                        onTap: () {
                          StorageService()
                    ...
                    : index == 2 && model.subusers.length == 2
                        ? InkWell(
                            onTap: () {
                              StorageService()
