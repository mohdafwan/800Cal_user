...
class FillYourBioScreenregister extends StatefulWidget {
  const FillYourBioScreenregister({super.key});

  @override
  State<FillYourBioScreenregister> createState() => _FillYourBioScreenState();
}

class _FillYourBioScreenState extends State<FillYourBioScreenregister> {
  String dob = "";
