            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      '${meal != null ? meal['food'].length > 0 ? '1' : '0' : '0'}/${controller.calendarModel.meals['meals'].where((element) => element['label'] == 'Breakfast').toList().isNotEmpty ? '1' : '0'}',
                      style: TextStyle(
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      '${meal != null ? meal['food'].length > 1 ? '1' : '0' : '0'}/${controller.calendarModel.meals['meals'].where((element) => element['label'] == 'Main').toList().isNotEmpty ? '1' : '0'}',
                      style: TextStyle(
                        color: AppColor.whiteColor,
                        fontSize: 8,
                        fontWeight: FontWeight.w700,
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      '${meal != null ? meal['food'].length > 2 ? '1' : '0' : '0'}/${controller.calendarModel.meals['meals'].where((element) => element['label'] == 'Snack/Soup').toList().isNotEmpty ? '1' : '0'}',
                      style: TextStyle(
                        color: AppColor.whiteColor,
                        fontSize: 8,
                        fontWeight: FontWeight.w700,
