...
class GroupRestaurantCard extends StatefulWidget {
  final GroupRestaurantModel model;
...
class _GroupRestaurantCardState extends State<GroupRestaurantCard> {
  ...
  _changeLanguage() async {
    title = await Get.put(TranslatorBackend())
        .translateText(widget.model.restaurant.title);
    setState(() {});
    log('text:${title}');
  }
  ...
  void initState() {
    ...
    super.initState();
    _changeLanguage();
    log('image:${widget.model.restaurant.logo},');
  }
