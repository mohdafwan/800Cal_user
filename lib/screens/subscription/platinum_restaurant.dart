...
class PlatinumRestaurantScreen extends StatelessWidget {
  const PlatinumRestaurantScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<RestaurantBackend>(builder: (controller) {
      List<GroupRestaurantModel> model = controller.groupRestaurantModel
          .where((element) =>
              element.price <= subscriptionModel.meal.platinumprice)
          .toList();
        ...
        children: [
          ...
          Positioned(
            ...
            child: SizedBox(
                ...
                child: CustomButton(
                  text:
                      "${c.lang == 'en' ? AppText.priceEn : AppText.priceAr} ${subscriptionModel.meal.platinumprice}${c.lang == 'en' ? AppText.kdEn : AppText.kdAr}",
                  onTap: () {
                    subscriptionModel.restaurant = model;
                    subscriptionModel.groupRestaurantCategory = "Platinum";
