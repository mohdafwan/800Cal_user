...
class CustomCalendar2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: GetBuilder<SubscriptionBackend>(builder: (controller) {
              ...
              child: InkWell(
                onTap: () {
                  if (isPicked && inBetween) {
                    Get.put(RestaurantBackend()).fetchSubscriptionRestaurant(
                        controller.calendarModel.listofrestaurants);
