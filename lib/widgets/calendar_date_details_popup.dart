...
import 'package:eight_hundred_cal/widgets/add_note_popup.dart';
...
void showCalendarDateDetailsPopup(
    BuildContext context, Map data, List restaurant) {
          ...
          Column(
            ...
            children: [
              ...
              widget.data['note'] != null &&
                      widget.data['note'].length > widget.index
                  ? Text(
                      'Note: ${widget.data['note'][widget.index]}',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: AppColor.reviewCardTextColor,
                        fontSize: 8,
      ...
      children: [
        ...
        Positioned(
          ...
          child: InkWell(
            onTap: () {
              Get.back();
              Get.put(RestaurantBackend())
                  .fetchSubscriptionRestaurant(restaurants);
              var controller = Get.put(RestaurantBackend());
              controller.edit = true;
